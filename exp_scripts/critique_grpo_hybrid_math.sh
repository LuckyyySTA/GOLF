...
# exp_name='qwen3-8b-no-think-openr1-critique-grpo-rollout8-prompt-8k-resp-6k-hybrid-training-mix-incorrect-only-threshold-0.125-answer-dapo'
# exp_name='qwen3-8b-no-think-openr1-critique-grpo-rollout8-prompt-8k-resp-6k-hybrid-training-mix-incorrect-only-threshold-0.125-answer-partial-correct'
exp_name='debug'
...
TRAIN_FILE=${TRAIN_FILE:-$ROOT/GOLF/data/openr1_math_4k_train.parquet}
TEST_FILE=${TEST_FILE:-$ROOT/GOLF/data/openr1_math_4k_test.parquet}
...
success_threshold=0.125  # 成功阈值 (比例 0-1): 0.125 表示至少需要 12.5% 的正确样本 (n=8 时至少 1 个), 1.0 表示需要全部正确
...
off_policy_reward_manager='prime' #prob/random/naive
reward_manager='prime'
val_reward_manager='prime'
