...
def default_compute_score(
    ...
    if data_source == "openai/gsm8k":
        ...
        res = compute_score(data_source, solution_str, ground_truth, extra_info)
    ...
    elif data_source in ["ifeval", "self_refined"]:
        from .ifeval import compute_score

        res = compute_score(solution_str, ground_truth, extra_info)
    elif data_source in ["ifbench"]:
        from .ifbench import compute_score
